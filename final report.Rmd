...
- Number of cluster(K)= 4 
  ...
  average silhouette width=0.43, sum of squares= 1900.127, BCubed precision= BCubed recall= 
  
- Number of cluster(K)= 3


  average silhouette width=0.37, sum of squares= 2908.955, BCubed precision=  BCubed recall= 
  
- Number of cluster(K)= 2


  average silhouette width=0.45, sum of squares= 4126, BCubed precision= BCubed recall= 
